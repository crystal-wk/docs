# Source: https://github.com/bytedance/deer-flow/tree/main
...
[**50** Branches](https://github.com/bytedance/deer-flow/branches) [**8** Tags](https://github.com/bytedance/deer-flow/tags)
...
[2,952 Commits](https://github.com/bytedance/deer-flow/commits/main/)
...
[.agent/skills](https://github.com/bytedance/deer-flow/tree/main/.agent/skills 'This path skips through empty directories')
...
[.github](https://github.com/bytedance/deer-flow/tree/main/.github '.github')
...
[backend](https://github.com/bytedance/deer-flow/tree/main/backend 'backend')
...
[contracts](https://github.com/bytedance/deer-flow/tree/main/contracts 'contracts')
...
[deploy/helm/deer-flow](https://github.com/bytedance/deer-flow/tree/main/deploy/helm/deer-flow 'This path skips through empty directories')
...
[docker](https://github.com/bytedance/deer-flow/tree/main/docker 'docker')
...
[docs](https://github.com/bytedance/deer-flow/tree/main/docs 'docs')
...
[frontend](https://github.com/bytedance/deer-flow/tree/main/frontend 'frontend')
...
[plans](https://github.com/bytedance/deer-flow/tree/main/plans 'plans')
...
[pr-build](https://github.com/bytedance/deer-flow/tree/main/pr-build 'pr-build')
...
[Fix abnormal preview of HTML files (](https://github.com/bytedance/deer-flow/commit/140907ce1d5ab4b8317f350deeed35e1579c0d1e 'Fix abnormal preview of HTML files (#1986)
...
* Harden HTML artifact preview isolation') [#1986](https://github.com/bytedance/deer-flow/pull/1986) [)](https://github.com/bytedance/deer-flow/commit/140907ce1d5ab4b8317f350deeed35e1579c0d1e 'Fix abnormal preview of HTML files (#1986)
...
[scripts](https://github.com/bytedance/deer-flow/tree/main/scripts 'scripts')
...
[skills/public](https://github.com/bytedance/deer-flow/tree/main/skills/public 'This path skips through empty directories')
...
[tests/skills](https://github.com/bytedance/deer-flow/tree/main/tests/skills 'This path skips through empty directories')
...
[.dockerignore](https://github.com/bytedance/deer-flow/blob/main/.dockerignore '.dockerignore')
...
[Adds Kubernetes sandbox provisioner support (](https://github.com/bytedance/deer-flow/commit/300e5a519a8f9680159ff27070600ab987726f85 'Adds Kubernetes sandbox provisioner support (#35)
...
already defined, reducing manual setup steps.') [#35](https://github.com/bytedance/deer-flow/pull/35) [)](https://github.com/bytedance/deer-flow/commit/300e5a519a8f9680159ff27070600ab987726f85 'Adds Kubernetes sandbox provisioner support (#35)
...
[.env.example](https://github.com/bytedance/deer-flow/blob/main/.env.example '.env.example')
...
[.gitattributes](https://github.com/bytedance/deer-flow/blob/main/.gitattributes '.gitattributes')
...
[fix(git):add .gitattributes to avoid 'bash\\r' issue (](https://github.com/bytedance/deer-flow/commit/5ad8a657f49fbbae296713d20a85fe5aadbf66d5 'fix(git):add .gitattributes to avoid 'bash\r' issue (#924)') [#924](https://github.com/bytedance/deer-flow/pull/924) [)](https://github.com/bytedance/deer-flow/commit/5ad8a657f49fbbae296713d20a85fe5aadbf66d5 'fix(git):add .gitattributes to avoid 'bash\r' issue (#924)')
...
[.gitignore](https://github.com/bytedance/deer-flow/blob/main/.gitignore '.gitignore')
...
[feat(trace): add agent observability with Monocle (](https://github.com/bytedance/deer-flow/commit/4af617835805dd7cd78162ebed02fd6b782ea8bf 'feat(trace): add agent observability with Monocle (#4024)
...
Co-authored-by: Claude Fable 5 <noreply@anthropic.com>
Co-authored-by: Willem Jiang <willem.jiang@gmail.com>') [#4024](https://github.com/bytedance/deer-flow/pull/4024) [)](https://github.com/bytedance/deer-flow/commit/4af617835805dd7cd78162ebed02fd6b782ea8bf 'feat(trace): add agent observability with Monocle (#4024)
...
[.pre-commit-config.yaml](https://github.com/bytedance/deer-flow/blob/main/.pre-commit-config.yaml '.pre-commit-config.yaml')
...
[AGENTS.md](https://github.com/bytedance/deer-flow/blob/main/AGENTS.md 'AGENTS.md')
...
[CHANGELOG.md](https://github.com/bytedance/deer-flow/blob/main/CHANGELOG.md 'CHANGELOG.md')
...
[CHANGELOG\_zh.md](https://github.com/bytedance/deer-flow/blob/main/CHANGELOG_zh.md 'CHANGELOG_zh.md')
...
[doc(changelog): update the changelog with the latest status of 2.1.0 …](https://github.com/bytedance/deer-flow/commit/26ba0b9e6af6f8a5428802176596b3733f5692be 'doc(changelog): update the changelog with the latest status of 2.1.0 PRs (#4484)
...
[CLAUDE.md](https://github.com/bytedance/deer-flow/blob/main/CLAUDE.md 'CLAUDE.md')
...
[CODE\_OF\_CONDUCT.md](https://github.com/bytedance/deer-flow/blob/main/CODE_OF_CONDUCT.md 'CODE_OF_CONDUCT.md')
...
[CONTRIBUTING.md](https://github.com/bytedance/deer-flow/blob/main/CONTRIBUTING.md 'CONTRIBUTING.md')
...
[fix(tests): require explicit opt-in for live client tests (](https://github.com/bytedance/deer-flow/commit/6b5f5e789a51fb0175b474ef7d5978013745a947 'fix(tests): require explicit opt-in for live client tests (#4482)

* fix(tests): require explicit opt-in for live client tests

* test: align live target with marker') [#4482](https://github.com/bytedance/deer-flow/pull/4482) [)](https://github.com/bytedance/deer-flow/commit/6b5f5e789a51fb0175b474ef7d5978013745a947 'fix(tests): require explicit opt-in for live client tests (#4482)
...
[Install.md](https://github.com/bytedance/deer-flow/blob/main/Install.md 'Install.md')
...
[docs: add install.md agent setup guide (](https://github.com/bytedance/deer-flow/commit/e1853df06aa2aefb10750834802cce10af79b936 'docs: add install.md agent setup guide (#1402)

* docs: add install.md agent setup guide

* docs: tighten install.md setup flow

* docs: address copilot review comments') [#1402](https://github.com/bytedance/deer-flow/pull/1402) [)](https://github.com/bytedance/deer-flow/commit/e1853df06aa2aefb10750834802cce10af79b936 'docs: add install.md agent setup guide (#1402)
...
[LICENSE](https://github.com/bytedance/deer-flow/blob/main/LICENSE 'LICENSE')
...
[docs: update LICENSE](https://github.com/bytedance/deer-flow/commit/88e89921b9d91d6ecad19e83ad103e2f38b2e59b 'docs: update LICENSE')
...
[Makefile](https://github.com/bytedance/deer-flow/blob/main/Makefile 'Makefile')
...
[feat: complete backend thread-boundary inventory (](https://github.com/bytedance/deer-flow/commit/d3ce5de218853e7cca6136a9ed9ba63111787158 'feat: complete backend thread-boundary inventory (#4562)
...
Add regression coverage and synchronize the detector CLI help assertion.') [#4562](https://github.com/bytedance/deer-flow/pull/4562) [)](https://github.com/bytedance/deer-flow/commit/d3ce5de218853e7cca6136a9ed9ba63111787158 'feat: complete backend thread-boundary inventory (#4562)
...
[README.md](https://github.com/bytedance/deer-flow/blob/main/README.md 'README.md')
...
[README\_fr.md](https://github.com/bytedance/deer-flow/blob/main/README_fr.md 'README_fr.md')
...
[docs(i18n): sync Langfuse tracing sections into ja/fr/ru README trans…](https://github.com/bytedance/deer-flow/commit/747806a9f631957f90ee110e514d02c31875bd2a 'docs(i18n): sync Langfuse tracing sections into ja/fr/ru README translations (#4045)
...
[README\_ja.md](https://github.com/bytedance/deer-flow/blob/main/README_ja.md 'README_ja.md')
...
[README\_ru.md](https://github.com/bytedance/deer-flow/blob/main/README_ru.md 'README_ru.md')
...
[README\_zh.md](https://github.com/bytedance/deer-flow/blob/main/README_zh.md 'README_zh.md')
...
[fix(memory): prevent task-scoped data from entering long-term memory (](https://github.com/bytedance/deer-flow/commit/cccda35cc52f837934cb54b6b328d97a16d090ca 'fix(memory): prevent task-scoped data from entering long-term memory (#4604)

* fix(memory): gate long-term updates by scope

* docs(memory): note custom prompts_dir migration; fix stale accept-filter comment

* fix(memory): harden scope-gate review paths') [#…](https://github.com/bytedance/deer-flow/pull/4604)
...
[RELEASING.md](https://github.com/bytedance/deer-flow/blob/main/RELEASING.md 'RELEASING.md')
...
[SECURITY.md](https://github.com/bytedance/deer-flow/blob/main/SECURITY.md 'SECURITY.md')
...
[config.example.yaml](https://github.com/bytedance/deer-flow/blob/main/config.example.yaml 'config.example.yaml')
...
[deer-flow.code-workspace](https://github.com/bytedance/deer-flow/blob/main/deer-flow.code-workspace 'deer-flow.code-workspace')
...
[feat: Add metadata and descriptions to various documentation pages in…](https://github.com/bytedance/deer-flow/commit/44d9953e2e2f4f2993660ecb191be86ed89e608a 'feat: Add metadata and descriptions to various documentation pages in Chinese
...
[extensions\_config.example.json](https://github.com/bytedance/deer-flow/blob/main/extensions_config.example.json 'extensions_config.example.json')
...
Learn more and see **real demos** on our [**official website**](https://deerflow.tech). The landing-page case studies open as allowlisted, read-only showcases without requiring a sign-in.

## Sister Projects

[![image](https://private-user-images.githubusercontent.com/1003147/621907406-077edef4-d560-41af-bb0d-d0a5f14fcc20.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..AfkYPUzNYp5NWbh1mY5jadaoI2D3vCua-GIaIHq-M3M)](https://private-user-images.githubusercontent.com/1003147/621907406-077edef4-d560-41af-bb0d-d0a5f14fcc20.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..AfkYPUzNYp5NWbh1mY5jadaoI2D3vCua-GIaIHq-M3M)
...
- [🦌 DeerFlow - 2.0](https://github.com/bytedance/deer-flow/tree/main#-deerflow---20)
 - [Official Website](https://github.com/bytedance/deer-flow/tree/main#official-website)
 - [Coding Plan from ByteDance Volcengine](https://github.com/bytedance/deer-flow/tree/main#coding-plan-from-bytedance-volcengine)
 - [InfoQuest](https://github.com/bytedance/deer-flow/tree/main#infoquest)
 - [Table of Contents](https://github.com/bytedance/deer-flow/tree/main#table-of-contents)
 - [One-Line Agent Setup](https://github.com/bytedance/deer-flow/tree/main#one-line-agent-setup)
 - [Quick Start](https://github.com/bytedance/deer-flow/tree/main#quick-start)
 - [Configuration](https://github.com/bytedance/deer-flow/tree/main#configuration)
 - [Running the Application](https://github.com/bytedance/deer-flow/tree/main#running-the-application)
 - [Deployment Sizing](https://github.com/bytedance/deer-flow/tree/main#deployment-sizing)
 - [Option 1: Docker (Recommended)](https://github.com/bytedance/deer-flow/tree/main#option-1-docker-recommended)
 - [Option 2: Local Development](https://github.com/bytedance/deer-flow/tree/main#option-2-local-development)
 - [Advanced](https://github.com/bytedance/deer-flow/tree/main#advanced)
 - [Sandbox Mode](https://github.com/bytedance/deer-flow/tree/main#sandbox-mode)
 - [MCP Server](https://github.com/bytedance/deer-flow/tree/main#mcp-server)
 - [IM Channels](https://github.com/bytedance/deer-flow/tree/main#im-channels)
 - [LangSmith Tracing](https://github.com/bytedance/deer-flow/tree/main#langsmith-tracing)
 - [Langfuse Tracing](https://github.com/bytedance/deer-flow/tree/main#langfuse-tracing)
 - [Monocle Tracing](https://github.com/bytedance/deer-flow/tree/main#monocle-tracing)
 - [Using Multiple Providers](https://github.com/bytedance/deer-flow/tree/main#using-multiple-providers)
 - [From Deep Research to Super Agent Harness](https://github.com/bytedance/deer-flow/tree/main#from-deep-research-to-super-agent-harness)
 - [Core Features](https://github.com/bytedance/deer-flow/tree/main#core-features)
 - [Skills & Tools](https://github.com/bytedance/deer-flow/tree/main#skills--tools)
 - [Claude Code Integration](https://github.com/bytedance/deer-flow/tree/main#claude-code-integration)
 - [Session Goals](https://github.com/bytedance/deer-flow/tree/main#session-goals)
 - [Manual Context Compaction](https://github.com/bytedance/deer-flow/tree/main#manual-context-compaction)
 - [Sub-Agents](https://github.com/bytedance/deer-flow/tree/main#sub-agents)
 - [Sandbox & File System](https://github.com/bytedance/deer-flow/tree/main#sandbox--file-system)
 - [Context Engineering](https://github.com/bytedance/deer-flow/tree/main#context-engineering)
 - [Long-Term Memory](https://github.com/bytedance/deer-flow/tree/main#long-term-memory)
 - [Recommended Models](https://github.com/bytedance/deer-flow/tree/main#recommended-models)
 - [Embedded Python Client](https://github.com/bytedance/deer-flow/tree/main#embedded-python-client)
 - [Scheduled Tasks](https://github.com/bytedance/deer-flow/tree/main#scheduled-tasks)
 - [Terminal Workbench (TUI)](https://github.com/bytedance/deer-flow/tree/main#terminal-workbench-tui)
 - [Documentation](https://github.com/bytedance/deer-flow/tree/main#documentation)
 - [⚠️ Security Notice](https://github.com/bytedance/deer-flow/tree/main#%EF%B8%8F-security-notice)
 - [Improper Deployment May Introduce Security Risks](https://github.com/bytedance/deer-flow/tree/main#improper-deployment-may-introduce-security-risks)
 - [Security Recommendations](https://github.com/bytedance/deer-flow/tree/main#security-recommendations)
 - [Contributing](https://github.com/bytedance/deer-flow/tree/main#contributing)
 - [License](https://github.com/bytedance/deer-flow/tree/main#license)
 - [Acknowledgments](https://github.com/bytedance/deer-flow/tree/main#acknowledgments)
 - [Key Contributors](https://github.com/bytedance/deer-flow/tree/main#key-contributors)
 - [Star History](https://github.com/bytedance/deer-flow/tree/main#star-history)
...
The Web UI displays a localized AI-generated-content disclaimer below the composer in both standard and custom-agent conversations, reminding users to verify important information.
...
`E2BSandboxProvider` uses `wait` as its default overflow policy. It waits for `acquire_timeout`, then fails the agent turn. DeerFlow does not retry the turn automatically. Clients can use the structured error to schedule a retry.

Use `burst` with `burst_limit` to permit bounded extra VMs. The `wait` and `reject` policies use only `replicas`. The `reject` policy can remove one warm VM before it returns an error.

With in-memory ownership, `replicas` limits one Gateway process. With Redis ownership, E2B shares one capacity Hash between workers using the same `sandbox.ownership.key_prefix`; `replicas` (plus a configured burst) is then a deployment-wide hard limit. Use one unique prefix and the same effective limit per deployment. To change the limit, stop its Gateways, delete the capacity Hash, and restart; mismatched workers fail closed.

The Hash counts remote VMs and in-flight creates, repairs interrupted creates from E2B metadata, grace-protects stale inventory omissions, and blocks new creates while Redis or initial inventory is unavailable. Run Redis with persistence, non-evicting memory, and HA.

E2B acquisition uses a bounded executor. Waiting acquisitions do not use the default asyncio executor.

An E2B VM keeps its slot until E2B confirms destruction. This rule covers create and reclaim operations. Discovery can find a VM from another Gateway. Shutdown closes an unowned discovery client without destroying its VM. Release stops counting a transition when the VM enters the warm pool. Shutdown races retry remote cleanup after a transient kill failure. Reset destroys tracked active and warm E2B VMs. The old provider instance cannot accept new acquisitions.
...
The workspace Browser Live client negotiates binary JPEG WebSocket frames, keeps only the newest pending frame per display refresh, and revokes replaced object URLs. Gateway control messages remain JSON, and clients that do not request the binary capability retain the legacy JSON/base64 frame protocol.
...
See [backend/docs/TUI.md](https://github.com/bytedance/deer-flow/blob/main/backend/docs/TUI.md) for the full guide.
...
An admin can register stdio MCP servers, which run commands inside the Gateway container. The API restricts them to an allowlist (`npx`, `uvx` by default, extended via `DEER_FLOW_MCP_STDIO_COMMAND_ALLOWLIST`) and rejects arguments and environment variables that would evaluate arbitrary code. That is defense in depth, not a boundary: these launchers exist to fetch and run remote packages, so **treat Gateway admin as equivalent to code execution on the host** and grant it accordingly.

### Deployment Defaults

The Docker stack publishes its entry port on `127.0.0.1` only, matching the local-trusted-environment model described above. To reach it from another machine, set `BIND_HOST` in `.env` (e.g. `BIND_HOST=0.0.0.0`) — and only after putting the security measures below in place.

**Complete first-run setup before the host becomes reachable.** A fresh instance has no accounts yet, so create the admin account through `/setup` immediately after starting any deployment that is not loopback-only.
...
Backend `make test` is offline by default and excludes live external-API coverage. Maintainers can explicitly run the real `DeerFlowClient` integration suite with `cd backend && make test-live` after providing a valid root `config.yaml` and API credentials; this may incur API costs and create local sandboxes, artifacts, or files. Direct pytest runs additionally require `DEER_FLOW_RUN_LIVE_TESTS=1`.
...
[agent](https://github.com/topics/agent) [agentic](https://github.com/topics/agentic) [agentic-framework](https://github.com/topics/agentic-framework) [agentic-workflow](https://github.com/topics/agentic-workflow) [ai](https://github.com/topics/ai) [ai-agents](https://github.com/topics/ai-agents) [deep-research](https://github.com/topics/deep-research) [harness](https://github.com/topics/harness) [langchain](https://github.com/topics/langchain) [langgraph](https://github.com/topics/langgraph) [langmanus](https://github.com/topics/langmanus) [llm](https://github.com/topics/llm) [multi-agent](https://github.com/topics/multi-agent) [nodejs](https://github.com/topics/nodejs) [podcast](https://github.com/topics/podcast) [python](https://github.com/topics/python) [superagent](https://github.com/topics/superagent) [typescript](https://github.com/topics/typescript)

### Resources

[Readme](https://github.com/bytedance/deer-flow/tree/main#readme-ov-file)

[MIT license](https://github.com/bytedance/deer-flow/tree/main#MIT-1-ov-file)

### Code of conduct

[Code of conduct](https://github.com/bytedance/deer-flow/tree/main#coc-ov-file)

### Contributing

[Contributing](https://github.com/bytedance/deer-flow/tree/main#contributing-ov-file)

### Security policy

[Security policy](https://github.com/bytedance/deer-flow/tree/main#security-ov-file)

[Activity](https://github.com/bytedance/deer-flow/activity)

[Custom properties](https://github.com/bytedance/deer-flow/custom-properties)
...
[**10.9k** forks](https://github.com/bytedance/deer-flow/forks)

[Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fbytedance%2Fdeer-flow&report=bytedance+%28user%29)

## [Releases](https://github.com/bytedance/deer-flow/releases)1 (1)

[DeerFlow 2.0.0 releasedLatest\\ \\ Jun 25, 2026](https://github.com/bytedance/deer-flow/releases/tag/v2.0.0)

## [Contributors](https://github.com/bytedance/deer-flow/graphs/contributors)368 (368)

- [![@WillemJiang](https://avatars.githubusercontent.com/u/219644?s=64&v=4)](https://github.com/WillemJiang)
- [![@MagicCube](https://avatars.githubusercontent.com/u/1003147?s=64&v=4)](https://github.com/MagicCube)
...
- [![@henry-byted](https://avatars.githubusercontent.com/u/209858577?s=64&v=4)](https://github.com/henry-byted)
- [![@Copilot](https://avatars.githubusercontent.com/in/946600?s=64&v=4)](https://github.com/Copilot)
...
- [![@AnnaSuSu](https://avatars.githubusercontent.com/u/64579968?s=64&v=4)](https://github.com/AnnaSuSu)
- [![@foreleven](https://avatars.githubusercontent.com/u/4785594?s=64&v=4)](https://github.com/foreleven)
...
- [![@DaoyuanLi2816](https://avatars.githubusercontent.com/u/94409450?s=64&v=4)](https://github.com/DaoyuanLi2816)
- [![@18062706139fcz](https://avatars.githubusercontent.com/u/90562015?s=64&v=4)](https://github.com/18062706139fcz)

[\+ 354 contributors](https://github.com/bytedance/deer-flow/graphs/contributors)

## Languages

- [Python81.3%](https://github.com/bytedance/deer-flow/search?l=python)
- [TypeScript14.2%](https://github.com/bytedance/deer-flow/search?l=typescript)
- [MDX1.8%](https://github.com/bytedance/deer-flow/search?l=mdx)
- [HTML1%](https://github.com/bytedance/deer-flow/search?l=html)
- [Shell0.7%](https://github.com/bytedance/deer-flow/search?l=shell)
- [CSS0.5%](https://github.com/bytedance/deer-flow/search?l=css)
- [Other0.5%](https://github.com/bytedance/deer-flow/search?l=Other)