# Source: https://github.com/bytedance/deer-flow/blob/main/CONTRIBUTING.md
...
[![ShitK](https://avatars.githubusercontent.com/u/80999801?v=4&size=40)](https://github.com/ShitK) [ShitK](https://github.com/bytedance/deer-flow/commits?author=ShitK)

[fix(tests): require explicit opt-in for live client tests (](https://github.com/bytedance/deer-flow/commit/6b5f5e789a51fb0175b474ef7d5978013745a947) [#4482](https://github.com/bytedance/deer-flow/pull/4482) [)](https://github.com/bytedance/deer-flow/commit/6b5f5e789a51fb0175b474ef7d5978013745a947)

Open commit detailssuccess

Jul 29, 2026

[6b5f5e7](https://github.com/bytedance/deer-flow/commit/6b5f5e789a51fb0175b474ef7d5978013745a947) · Jul 29, 2026

## History

[History](https://github.com/bytedance/deer-flow/commits/main/CONTRIBUTING.md)

Open commit details

History

390 lines (300 loc) · 13 KB
...
[Raw](https://github.com/bytedance/deer-flow/raw/refs/heads/main/CONTRIBUTING.md)
...
4. **Access the application**:
 ...
 - LangGraph-compatible API: [http://localhost:2026/api/langgraph/](http://localhost:2026/api/langgraph/)\*
...
DeerFlow is an AI project and we welcome AI-assisted contributions. To help reviewers calibrate how closely to read a change, **every pull request must complete the "AI assistance" section of the [PR template](https://github.com/bytedance/deer-flow/blob/main/.github/pull_request_template.md)**:
...
`make test-live` calls real external APIs and may incur API costs or create local sandboxes, artifacts, and files. It is never run by the default backend test command or CI. Direct pytest invocations of `tests/test_client_live.py` must also set `DEER_FLOW_RUN_LIVE_TESTS=1`.

### PR Regression Checks

Every pull request triggers the following CI workflows:

- **Backend unit tests** — [.github/workflows/backend-unit-tests.yml](https://github.com/bytedance/deer-flow/blob/main/.github/workflows/backend-unit-tests.yml)
- **Frontend unit tests** — [.github/workflows/frontend-unit-tests.yml](https://github.com/bytedance/deer-flow/blob/main/.github/workflows/frontend-unit-tests.yml)
- **Frontend E2E tests** — [.github/workflows/e2e-tests.yml](https://github.com/bytedance/deer-flow/blob/main/.github/workflows/e2e-tests.yml) (triggered only when `frontend/` files change)
...
- [Configuration Guide](https://github.com/bytedance/deer-flow/blob/main/backend/docs/CONFIGURATION.md) - Setup and configuration
- [Architecture Overview](https://github.com/bytedance/deer-flow/blob/main/backend/CLAUDE.md) - Technical architecture
- [MCP Setup Guide](https://github.com/bytedance/deer-flow/blob/main/backend/docs/MCP_SERVER.md) - Model Context Protocol configuration
...
- Read the [Documentation](https://github.com/bytedance/deer-flow/blob/main/backend/docs)
